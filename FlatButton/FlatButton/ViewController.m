...
@property (nonatomic, strong) FlatButton * anotherButton;
...
- (FlatButton *)button{
  if (!_button) {
    _button = [[FlatButton alloc] init];
    _button.frame = CGRectMake(60, 100, 200, 40);
...
- (FlatButton *)anotherButton{
  if (!_anotherButton) {
    _anotherButton = [[FlatButton alloc] init];
    _anotherButton.frame = CGRectMake(100, 200, 120, 40);
