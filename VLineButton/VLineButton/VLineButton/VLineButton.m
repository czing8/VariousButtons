...
+ (VLineButton *)button {
    return [VLineButton buttonWithType:UIButtonTypeCustom];
}
...
- (void)drawRect:(CGRect)rect {
    ...
    UIBezierPath *outlinePath = [UIBezierPath bezierPathWithRoundedRect:CGRectInset(self.bounds, lineWidth, lineWidth) cornerRadius:MIN(CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds))/2];
    ...
    if (self.highlighted) {
        CGContextSaveGState(ctx);
        UIBezierPath *fillPath = [UIBezierPath bezierPathWithRoundedRect:CGRectInset(self.bounds, lineWidth * 2.5, lineWidth * 2.5) cornerRadius:MIN(CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds))/2];
